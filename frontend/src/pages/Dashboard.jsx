...
export default function Dashboard() {
    ...
    const fetchMyPosts = () => {
        ...
        axios
            // mine=1 tells backend to return only posts authored by current user
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Manage your posts and track your writing
                                activity
                            </p>
                        </div>
                        <Link
                ...
                <div className="bg-white rounded-xl shadow border border-gray-100 overflow-hidden mb-8">
                    <div className="border-b border-gray-200">
                        <div className="px-6 py-4">
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                All posts you've created. Only you can edit or
                                delete these posts.
                            </p>
                        </div>
                    </div>
                                    ...
                                    >
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                            ...
                                            <div className="flex items-center gap-2 flex-shrink-0">
                                                ...
                                                {/* You can implement an edit page later */}
                                                <button
                                                    type="button"
                                                    onClick={() =>
                                                        alert(
                                                            "Edit page not implemented yet."
                                                        )
                                                    }
                                ...
                                <div className="w-12 h-12.rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 text-white flex.items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                                    ...
                                    >
                                        <path
                                            ...
                                            strokeLinejoin="round"
                                            strokeWidth="2"
                                            d="M19 11H5m14 0a2 2 0 012.2v6a2.2 2 0 01-2.2 2H5a2.2 2 0 01-2.2-2v-6a2.2 2 0 012.2-2m14 0V9a2.2 2 0 00-2.2-2M5 11V9a2.2 2 0 012.2-2m0 0V5a2.2 2 0 012.2-2h6a2.2 2 0 012.2 2v2M7 7h10"
                                        />
                                    </svg>
                                </div>
                                <div>
